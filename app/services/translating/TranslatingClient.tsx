...
export default function TranslatingClient() {
  const steps = [
    ...
    "The project is matched with an industry-specific translator",
    "Proofreading and quality control are performed",
    "Final translation is delivered with optional certification",
  ];
    ...
    <section className="relative min-h-screen w-full bg-[#f4f4f4] text-[#000957] flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 px-6 py-24 space-y-16 max-w-3xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h1 className="text-4xl font-extrabold mb-4 py-12">Professional Translation Services</h1>
          <p className="text-lg leading-relaxed">
            At <strong>Vangard Translations</strong>, we offer expert language translation in languages,
            delivered by certified native translators. Whether it's legal, medical, financial, or technical content,
            we ensure your message is conveyed with complete accuracy and cultural fluency.
          </p>
        </motion.div>
        ...
        >
          ...
          <ul className="list-disc list-inside text-base space-y-2">
            <li>Mother-tongue translators with subject-matter expertise</li>
            <li>Certified professionals (NRPSI, CIOL, and more)</li>
            <li>Optional stamped and signed certifications</li>
            <li>Fast turnaround and strict confidentiality</li>
          </ul>
        </motion.div>
