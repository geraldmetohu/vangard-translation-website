...
export default function AboutUs() {
  return (
    <div className="w-full text-[#0D47A1]">
      {/* Hero Section - full width, no padding */}
      <div className="relative w-full h-[60vh] lg:h-[80vh] flex items-center justify-center text-center bg-[#0c1f3b] text-[#e7d240] overflow-hidden">
        <Image
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <section className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6 bg-white shadow-md rounded-xl text-center border border-[#e7d240]">
            <h3 className="text-xl font-bold">Accuracy & Precision</h3>
            <p className="mt-3">
              We deliver reliable translations backed by technical expertise and subject knowledge.
            </p>
          </div>
          <div className="p-6 bg-white shadow-md rounded-xl text-center border border-[#e7d240]">
            <h3 className="text-xl font-bold">Client Commitment</h3>
            <p className="mt-3">
              Each project receives our full attention—from first word to final delivery.
            </p>
          </div>
          <div className="p-6 bg-white shadow-md rounded-xl text-center border border-[#e7d240]">
            <h3 className="text-xl font-bold">Global Expertise</h3>
            <p className="mt-3">
              We match clients with translators who understand their industry, language, and culture.
            </p>
          </div>
        </section>
        ...
        <section className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="p-6 bg-white shadow-md rounded-xl border border-[#d3d3d3]">
            <h3 className="text-xl font-bold">Certified Translations</h3>
            <p className="mt-3">
              Officially notarised documents for legal, academic, and government use—fast, secure, and compliant.
            </p>
          </div>
          <div className="p-6 bg-white shadow-md rounded-xl border border-[#d3d3d3]">
            <h3 className="text-xl font-bold">Multilingual Transcriptions</h3>
            <p className="mt-3">
              Accurate transcripts in over 100 languages—perfect for media, research, and corporate use.
            </p>
          </div>
          <div className="p-6 bg-white shadow-md rounded-xl border border-[#d3d3d3]">
            <h3 className="text-xl font-bold">Globalisation Consulting</h3>
            <p className="mt-3">
              Ready to go global? Let us support your international expansion with localized strategies.
            </p>
          </div>
        </section>
        ...
        {/*
        <section className="mt-20 text-center">
          <h2 className="text-2xl lg:text-4xl font-semibold text-[#e7d240]">
            Meet Our Team
          </h2>
